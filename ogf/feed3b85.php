...
<rdf:RDF
    ...
    <channel rdf:about="feed.php">
        <title>&lt;b&gt;Open Grid Forum&lt;/b&gt; events:ogf-38b</title>
        <description></description>
        <link>https://www.ogf.org/ogf/</link>
        <image rdf:resource="lib/tpl/ogf/images/favicon.ico" />
       <dc:date>2022-10-26T06:13:57+0000</dc:date>
        <items>
            <rdf:Seq>
    ...
    <item rdf:about="https://www.ogf.org/ogf/doku.php/events/ogf-38b/call_for_session_proposals?rev=1369070944&amp;do=diff">
        ...
        <title>events:ogf-38b:call_for_session_proposals</title>
        <link>https://www.ogf.org/ogf/doku.php/events/ogf-38b/call_for_session_proposals?rev=1369070944&amp;do=diff</link>
        <description>July 22-25, 2013

San Diego, USA


The OGF-38b program committee seeks active participation from the community, and encourages the submission of session proposals that may include (but are not limited to) the following topics:
	...
	*  OGF Chartered Group Sessions</description>
    ...
    <item rdf:about="https://www.ogf.org/ogf/doku.php/events/ogf-38b/lodging?rev=1369337680&amp;do=diff">
        ...
        <dc:creator>Anonymous (anonymous@undisclosed.example.com)</dc:creator>
        <title>events:ogf-38b:lodging</title>
        <link>https://www.ogf.org/ogf/doku.php/events/ogf-38b/lodging?rev=1369337680&amp;do=diff</link>
        <description>San Diego Marriott Marquis &amp; Marina, 333 West Harbor Drive, San Diego, California.

BOOK ONLINE BY JUNE 21 TO RECEIVE XSEDE13 SPECIAL RATES

The special XSEDE13 conference room rates are:
...
According to the XSEDE 13 lodging page, group room rates will be honored three (3) days post program dates, based on availability. Book by June 21 to receive the conference room rate. Hotel room rates are subject to applicable state and …</description>
    ...
    <item rdf:about="https://www.ogf.org/ogf/doku.php/events/ogf-38b/registration?rev=1369336738&amp;do=diff">
        ...
        <dc:creator>Anonymous (anonymous@undisclosed.example.com)</dc:creator>
        <title>events:ogf-38b:registration</title>
    ...
    <item rdf:about="https://www.ogf.org/ogf/doku.php/events/ogf-38b/schedule?rev=1369336830&amp;do=diff">
        ...
        <dc:creator>Anonymous (anonymous@undisclosed.example.com)</dc:creator>
        <title>events:ogf-38b:schedule</title>
    ...
    <item rdf:about="https://www.ogf.org/ogf/doku.php/events/ogf-38b/sidebar?rev=1368995992&amp;do=diff">
        ...
        <dc:creator>Anonymous (anonymous@undisclosed.example.com)</dc:creator>
        <title>events:ogf-38b:sidebar</title>
        <link>https://www.ogf.org/ogf/doku.php/events/ogf-38b/sidebar?rev=1368995992&amp;do=diff</link>
        <description>Events
...
- Schedule</description>
    ...
    <item rdf:about="https://www.ogf.org/ogf/doku.php/events/ogf-38b/travel?rev=1369337547&amp;do=diff">
        ...
        <dc:creator>Anonymous (anonymous@undisclosed.example.com)</dc:creator>
        <title>events:ogf-38b:travel</title>
    ...
    <item rdf:about="https://www.ogf.org/ogf/doku.php/events/ogf-38b/venue?rev=1369337769&amp;do=diff">
        ...
        <dc:creator>Anonymous (anonymous@undisclosed.example.com)</dc:creator>
        <title>events:ogf-38b:venue</title>
        <link>https://www.ogf.org/ogf/doku.php/events/ogf-38b/venue?rev=1369337769&amp;do=diff</link>
        <description>OGF 38b will be held in conjunction with and as part of the XSEDE 13 conference at the San Diego Marriott Marquis &amp; Marina, 333 West Harbor Drive, San Diego, California. For more information and links to registration and other details, see the event home page.</description>
    </item>
</rdf:RDF>
